		            ...
		            <div class="header_right">
			            <?php	
							...
							{	
			        			...
			        			$cart_size = count($this->cart->contents());
						?>

								<div id="orders_header">
									<?php echo '<a href="' . base_url("index.php/products_controller/orders")  . '">Orders</a>'; ?>
								</div>

								<div id="cart_header">
									<?php echo '<a href="' . base_url("index.php/products_controller/products_cart")  . '">Cart(' . $cart_size . ')</a>'; ?>
								</div>
			            ...
			            <?php
			            	...
			            	{
			            		echo '<div id="cart_header"><a href="' . base_url("index.php/accounts_controller/control_panel") . '">' . $this->session->userdata('username') . '</a></div>';
			            		echo '<div id="logout_btn"><a href="' . base_url("index.php/accounts_controller/logout_user") . '">(Logout)</a></div>';
			            		//echo '<div id="'
			            	}  
