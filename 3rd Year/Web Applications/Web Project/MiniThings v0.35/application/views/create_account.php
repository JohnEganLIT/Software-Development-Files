...
<?php
	...
	echo '<div id="create_account_form">';
		...
		echo form_input(array('class' => 'form_field', 'name' => 'first_name', 'type' => 'text', 'placeholder' => 'First Name', 'required'=>'required'));
		echo form_input(array('class' => 'form_field', 'name' => 'last_name', 'type' => 'text', 'placeholder' => 'Last Name', 'required'=>'required'));
	...
	echo '<div id="login_form">';		
		echo form_open('accounts_controller/login'); 
