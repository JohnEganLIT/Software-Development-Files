...
class accounts_controller extends CI_Controller
{
    ...
    public function create_account()
    {
        ...
        while($loop == true)
        {
            $customer_id = mt_rand(10000,99999);
    ...
    {    
        ...
        if($this->input->post("email"))
        {
            ...
            $result = $this->accounts_model->get_admin($email); //Gets ID and password hash of user
            ...
            {        
                ...
                {
                    //Set the session variables, logging the user in
                    $sessiondata = array('admin_id' => $admin_id, 'email' => $email);
                    $this->session->set_userdata($sessiondata);
                    redirect("main_controller");
                }
