...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://src/", "add");
    private final static QName _AddResponse_QNAME = new QName("http://src/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://src/", "multiplyResponse");
    private final static QName _Multiply_QNAME = new QName("http://src/", "multiply");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://src/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://src/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://src/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://src/", name = "multiply")
