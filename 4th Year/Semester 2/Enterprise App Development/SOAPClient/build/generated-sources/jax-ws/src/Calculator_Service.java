 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://src/", wsdlLocation = "http://localhost:8084/WebApplication1/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://src/", "Calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/WebApplication1/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://src/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://src/", "CalculatorPort"), Calculator.class, features);
    }
