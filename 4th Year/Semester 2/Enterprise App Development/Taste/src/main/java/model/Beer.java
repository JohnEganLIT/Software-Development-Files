...
@NamedQueries({
    ...
    , @NamedQuery(name = "Beer.findById", query = "SELECT b FROM Beer b WHERE b.id = :id")
...
public class Beer implements Serializable {
    ...
    public Beer(Integer id, int breweryId, String name, int catId, int styleId, float abv, float ibu, float srm, String description, int addUser, Date lastMod, String image, double buyPrice, double sellPrice) {
        this.id = id;
